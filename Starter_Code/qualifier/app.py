...
def see_qualifying_loans(qualifying_loans):
    """Print out the qualifying loans for the user to see
...
def run():
    ...
    # Print out qualifying loans
    see_qualifying_loans(qualifying_loans)
